        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          <div className="group p-8 sm:p-10 rounded-[40px] bg-surface border border-border shadow-2xl shadow-foreground/5 flex items-start space-x-6 transition-all duration-500 hover:border-primary-500 hover:shadow-2xl hover:shadow-primary-500/10 hover:-translate-y-2">
            ...
            <div className="space-y-4">
              <h3 className="font-heading font-black text-2xl text-foreground leading-tight tracking-tight">Our Vision</h3>
          ...
          <div className="group p-8 sm:p-10 rounded-[40px] bg-surface border border-border shadow-2xl shadow-foreground/5 flex items-start space-x-6 transition-all duration-500 hover:border-primary-500 hover:shadow-2xl hover:shadow-primary-500/10 hover:-translate-y-2">
            ...
            <div className="space-y-4">
              <h3 className="font-heading font-black text-2xl text-foreground leading-tight tracking-tight">Our Mission</h3>
              <p className="text-text-sub text-base leading-relaxed font-medium">
      ...
      <section className="py-20 lg:py-32 bg-bg-gradient-to/50 dark:bg-slate-900/20 border-y border-border px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((v, i) => (
              <div key={i} className="group p-8 rounded-[32px] bg-surface border border-border flex flex-col items-start space-y-6 transition-all duration-500 hover:border-primary-500 hover:shadow-2xl hover:shadow-primary-500/10 hover:-translate-y-2 shadow-xl shadow-foreground/5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
            {securityMeasures.map((measure, idx) => (
              <div key={idx} className="group p-8 rounded-[32px] bg-surface border border-border shadow-xl shadow-foreground/5 flex flex-col justify-between transition-all duration-500 hover:border-primary-500 hover:shadow-2xl hover:shadow-primary-500/10 hover:-translate-y-2">
