...
export const SEO: React.FC<SEOProps> = ({
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content={siteConfig.seoDefaults.openGraph.siteName} />
      <meta property="og:image" content={`${siteConfig.websiteUrl}/og-image.jpg`} />

      {/* Twitter Cards */}
      <meta name="twitter:card" content={siteConfig.seoDefaults.twitter.cardType} />
      <meta name="twitter:creator" content={siteConfig.seoDefaults.twitter.handle} />
      <meta name="twitter:title" content={metaTitle} />
      <meta name="twitter:description" content={metaDesc} />
      <meta name="twitter:image" content={`${siteConfig.websiteUrl}/og-image.jpg`} />
