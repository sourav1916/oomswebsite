          ...
          <div>
            ...
            <ul className="space-y-3.5">
              {[
                ...
                <li key={link.path}>
                  <Link to={link.path} className="text-sm font-medium hover:text-primary-600 transition-colors duration-200">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3.5 text-sm font-medium">
              ...
              <li className="flex items-center space-x-2.5">
                ...
                <a href={`mailto:${siteConfig.supportEmail}`} className="hover:text-primary-600 transition-colors">
                  {siteConfig.supportEmail}
                </a>
              </li>
              <li className="flex items-center space-x-2.5">
                <Phone className="w-4 h-4 text-primary-600 shrink-0" />
                <a href={`tel:${siteConfig.phoneNumbers[0].replace(/\s+/g, '')}`} className="hover:text-primary-600 transition-colors">
